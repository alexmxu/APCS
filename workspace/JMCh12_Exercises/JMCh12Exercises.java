...
public class JMCh12Exercises
{
    ...
    {
        char[] a = new char[] { 'r', 'r', 'r', 'p', 'p', 'p', 'p', 'p', 's',
            's', 's', 's', 's', 's', };
    ...
    public String whatDoesMysteryCountCount()
    {
        ...
        String answer = mCount
            + "if the first number is 0, the first chain of zeroes";
    ...
    public static int[] createWedge( int n )
    {
        ...
        int midpoint = ( wedge.length / 2 );
        wedge[midpoint - 1] = n;
        for ( int i = 0; i < n; i++ )
        {
            wedge[midpoint - i] = n - i;
    ...
    public static int computeScore( String word )
    {
        ...
        {
            score += letterScores[alphabet.indexOf( wordArr[i] )];
        }
        return score;
    }
    ...
    public static void main( String[] args )
    {
        ...
        do
        {
            ...
            System.out
                .println( "   (8) 12-7 makePythagoreanTriple( int m, int n )" );
            ...
            System.out
                .println( "   (D) 12-13 removeMin( ArrayList<Integer> list )" );
            System.out.println(
            ...
            if ( response.length() > 0 )
            {
                ...
                switch ( response.charAt( 0 ) )
                {
                    ...
                    case 'k':
                        ...
                        System.out.println(
                            "covers( m1, m2 ) = " + exercise.covers( m1, m2 ) );
                        m1[0][0] = -10;
                        System.out.println(
                            "covers( m1, m2 ) = " + exercise.covers( m1, m2 ) );
                        break;
