...
public class CardTester
{
    ...
    public static void main( String[] args )
    {
        ...
        /** 
         * prints out all attributes of the card
         */
        ...
        System.out.println();
        /** 
         * prints if two cards are matching or not
         * 1st line: ace of clubs 1 and ace of clubs 2 (matching)
         * 2nd line: ace of clubs and six of hearts (not matching)
         */
